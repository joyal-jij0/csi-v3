                ...
                {people1.map((eachPerson, index) => (
                    <div key={index} className="font-medium">
                        ...
                        <div className="text-xs sm:text-xl text-center p-4">
                            <h2 className="bg-clip-text text-transparent bg-gradient-to-r from-red-200 to-rose-800 cursor-default">
                                {eachPerson.name}
                            </h2>
                            <h2 className="bg-clip-text text-transparent bg-gradient-to-r from-blue-800 to-indigo-300 cursor-default">
                                {eachPerson.position}
                            </h2>
                        </div>
                    </div>
