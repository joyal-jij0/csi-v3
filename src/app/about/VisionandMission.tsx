        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-8">
                <div className="group w-full md:w-1/2">
                    <div className="bg-[#1d7a16]/60 p-6 rounded-lg transform transition-all hover:-translate-y-2 duration-300 relative before:absolute before:-inset-1 before:rounded-lg before:pointer-events-none before:opacity-0 group-hover:before:opacity-100 before:transition-opacity before:duration-300 before:bg-gradient-to-r before:from-[#1d7a16] before:to-[#41d324]">
                        <div className="flex items-center mb-4 relative z-10">
                            <div className="bg-gradient-to-br from-[#1d7a16] to-[#41d324] p-3 rounded-full mr-4">
