    ...
    <section className="py-16 px-4 md:px-8 lg:px-16 bg-black text-white">
        <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
                ...
                <div className="h-1 w-24 bg-gradient-to-r from-[#1d7a16] to-[#41d324] mx-auto"></div>
            </div>
            <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch">
                <div className="group flex-1 max-w-xl flex flex-col">
                    <div className="bg-[#1d7a16]/60 p-8 rounded-lg transform transition-all duration-300 hover:-translate-y-2 relative before:absolute before:-inset-1 before:rounded-lg before:pointer-events-none before:opacity-0 group-hover:before:opacity-100 before:transition-opacity before:duration-300 before:bg-gradient-to-r before:from-[#1d7a16] before:to-[#41d324] shadow-lg h-full flex flex-col">
                        ...
                        <div className="text-green-100 relative z-10 text-center text-lg md:text-xl flex-1 flex items-center justify-center min-h-[120px]">
