...
function formatDate(dateInput: string | Date): string {
    ...
    export default function EventDetailsDialogNew({
        isOpen,
        onClose,
        activeEvent,
                                    ...
                                    {activeEvent.guest && (
                                        <div className="w-full p-3 bg-gray-800/50 rounded-lg border border-gray-700">
                                            <div className="flex items-center gap-2 text-emerald-400">
                                                ...
                                                <span className="font-semibold ">Special Guest</span>
                                            </div>
                                            <p className="mt-1 text-sm text-gray-300 text-left">{activeEvent.guest}</p>
                                        </div>
                                    )}
                                </div>
                            </div>
